const page = () => {
  const textStyle = 'font-semibold mb-7';
  return (
    <div className="bg-gradient-to-r from-sky-100 to-orange-50">
      <div className="px-3 md:px-12 py-10 max-w-[1400px] mx-auto">
        <div className="mb-10">
          <h1 className="text-center text-6xl font-bold mb-3">
            Privacy Policy
          </h1>
          <h2 className="font-semibold text-lg text-gray-500 mb-3 text-center">
        ...
        <div className="mb-5">
          ...
          <h3 className="text-2xl font-semibold mb-5">Interpretation</h3>
          <p className="mb-5">
          ...
          <h3 className="text-2xl font-semibold mb-5">Definitions</h3>
          ...
          <ul className="ml-5 pl-5">
            ...
            <li className="list-disc">
              ...
              Agreement&#x2769; refers to shannonit, 41/14 A, Hazi Afsar Uddin
              Road, Zigatola, Dhaka.
            </li>
            <li className="list-disc">
            ...
            <li className="list-disc">
              <span className="font-semibold"> </span>means any natural or legal
            ...
            <li className="list-disc">
              ...
              shannonit, accessible from https://www.shannonit.org/
            </li>
            <li className="list-disc">
        ...
        <div className="mb-5">
          ...
          <h4 className="text-xl font-semibold mb-5">Personal Data</h4>
          <p className="mb-5">
          ...
          <div className="mt-5">
            <h4 className="text-xl font-semibold mb-5">Usage Data</h4>
            <p className="mb-5">
          ...
          <div className="mt-5">
            ...
            <ul className="ml-5 pl-5">
              ...
              <li className="list-disc">
                ...
                electronic files known as web beacons &#x2768;also referred to
                as clear gifs, pixel tags, and single-pixel gifs&#x2769; that
            ...
            <ul className="ml-5 pl-5">
              <li className="list-disc">
                <p className="font-semibold mb-5">Web Beacons.</p>
                <p className="mb-5">Administered by: Us</p>
                <p className="mb-5">
              ...
              <li className="list-disc">
                ...
                <p className="mb-5">Type: Persistent Cookies</p>
                <p className="mb-5">Administered by: Us</p>
                <p className="mb-5">
              ...
              <li className="list-disc">
                <p className="font-semibold mb-5">Functionality Cookies</p>
                <p className="mb-5">Type: Persistent Cookies</p>
                <p className="mb-5">Administered by: Us</p>
                <p className="mb-5">
          ...
          <div>
            ...
            <div>
              <h4 className="text-xl font-semibold mb-5">Law enforcement</h4>
              <p className="mb-5">
        ...
        <div className="mb-5">
          <h2 className="text-4xl font-bold mb-5">Children's Privacy</h2>
          <p className="mb-5">
        ...
        <div className="mb-5">
          <h2 className="text-4xl font-bold mb-5">Links to Other Websites</h2>
          <p className="mb-5">
        ...
        <div className="mb-5">
          ...
          <ul className="ml-5 pl-5">
            <li className="list-disc mb-3">By email: info@shannonit.org</li>
            <li className="list-disc mb-3">
              By visiting this page on our website:
              https://www.shannonit.org/contact
            </li>
            <li className="list-disc mb-3">By phone number: +8801743136127</li>
          </ul>
        </div>
      </div>
    </div>
