  ...
  return (
    <div className="bg-gradient-to-r from-sky-100 to-orange-50">
      <div className="px-3 md:px-12 py-10 max-w-[1400px] mx-auto">
        ...
        <div>
          <h2 className="font-semibold text-lg text-gray-500 mb-3">
            Last updated February 20, 2024
          </h2>
          <h2 className="font-semibold">AGREEMENT TO OUR LEGAL TERMS</h2>
          <p className={textStyle}>
            We are shannonit. A company registered in Bangladesh at 41/14 A,
            Hazi Afsar Uddin Road, Zigatola, Dhaka, dhaka, dhaka 1209. Our VAT
            number is 550693577139.
            <br />
            We operate the website https://www.shannonit.org, as well as any
            other related products and services that refer or link to these
            legal terms. <br />
            You can contact us by phone at +8801743136127, email at
            info@shannonit.org, or by mail to 41/14 A, Hazi Afsar Uddin Road,
            Zigatola, Dhaka, dhaka, dhaka 1209, Bangladesh. <br />
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity and
            shannonit, concerning your access to and use of the Services. You
            ...
            effective upon posting or notifying you by info@shannonit.org, as
        ...
        <p className={textStyle}>
          <span className="font-semibold">1. OUR SERVICES</span> <br />
        ...
        <div>
          ...
          <p className="mb-5">
            <span className="inline-block font-semibold pb-2">
          ...
          <div className="flex flex-col gap-5 mb-5">
            ...
            <p>
              ...
              Terms, please address your request to: info@shannonit.org. If we
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">Your submissions</p>
            <p>
              Please review this section and the "PROHIBITED ACTIVITIES" section
              carefully prior to using our Services to understand the
              &#x2768;a&#x2769; rights you give us and &#x2768;b&#x2769;
            ...
            <p>
              ...
              because of your breach of &#x2768;a&#x2769; this section,
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">3. USER REPRESENTATIONS</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">4. PROHIBITED ACTIVITIES</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">5. USER GENERATED CONTRIBUTIONS</p>
            <p>
              ...
              &#x2768;collectively, "Contribution&#x2769;. Contributions may be
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">6. CONTRIBUTION LICENSE</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">7. GUIDELINES FOR REVIEWS</p>
            <p>
              ...
              criteria: &#x2768;1&#x2769; you should have firsthand experience
              with the person/entity being reviewed; &#x2768;2&#x2769; your
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">8. THIRD-PARTY WEBSITES AND CONTENT</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">9. SERVICES MANAGEMENT</p>
            <p>
              ...
              these Legal Terms, including without limitation, reporting such
              user to law enforcement authorities; &#x2768;3&#x2769; in our sole
              ...
              &#x2768;5&#x2769; otherwise manage the Services in a manner
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">10. PRIVACY POLICY</p>
            <p>
              We care about data privacy and security. Please review our Privacy
              Policy: https://www.shannonit.org/privacy-policy. By using the
              Services, you agree to be bound by our Privacy Policy, which is
              incorporated into these Legal Terms. Please be advised the
              Services are hosted in the United States and United States. If you
              ...
              transferred to and processed in the United States and United
              States.
            </p>
          </div>
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">11. TERM AND TERMINATION</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">12. MODIFICATIONS AND INTERRUPTIONS</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">14. DISPUTE RESOLUTION</p>
            <p>
              These Legal Terms and your use of the Services are governed by and
              construed in accordance with the laws of the State of Delaware
              applicable to agreements made and to be entirely performed within
            ...
            <p className="mb-5">
              ...
              &#x2768;"AAA Consumer Rules"&#x2769;, both of which are available
              ...
              law, the arbitration will take place in Sussex County, Delaware.
              ...
              state and federal courts located in orange, California, and the
              ...
              any way to the Services be commenced more than one
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">15. CORRECTIONS</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">16. DISCLAIMER</p>
            <p>
              ...
              THE SERVICES, &#x2768;3&#x2769; ANY UNAUTHORIZED ACCESS TO OR USE
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">17. LIMITATIONS OF LIABILITY</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">18. INDEMNIFICATION</p>
            <p>
              ...
              Services;&#x2768;2&#x2769; breach of these Legal Terms;
              &#x2768&#x2769; any breach of your representations and warranties
              set forth in these Legal Terms;&#x2768;4&#x2769; your violation of
              the rights of a third party, including but not limited to
              intellectual property rights; or &#x2768;&#x2769; any overt
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">19. USER DATA</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">21. MISCELLANEOUS</p>
            <p>
          ...
          <div className="flex flex-col gap-5 mb-5">
            <p className="font-semibold">22. CONTACT US</p>
            <p>
            ...
            <div>
              <p className="font-semibold pb-2">shannonit</p>
              <p className="font-semibold pb-2">
                41/14 A, Hazi Afsar Uddin Road, Zigatola, Dhaka
              </p>
              <p className="font-semibold pb-2">dhaka, dhaka 1209</p>
              <p className="font-semibold pb-2">Bangladesh</p>
              <p className="font-semibold pb-2">Phone: +8801743136127</p>
              <p className="font-semibold pb-2">info@shannonit.org</p>
            </div>
          </div>
        </div>
      </div>
